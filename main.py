...
all_sounds_list = list(sounds.values())  # для рандомного режима
GEN_DIR = "assets/data/sounds"  # папка для синтетических wav
generated_sounds = {}          # key -> Sound (если тумблер ON)
...
def on_toggle_random(value: bool):
